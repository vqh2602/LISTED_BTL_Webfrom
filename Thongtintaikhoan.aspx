<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Thongtintaikhoan.aspx.cs" Inherits="LISTED.Thongtintaikhoan" %>
            ...
            <h1 runat="server" id="xinchao" OnClientClick="return false;">Xin Chào . . .</h1>
                <div id="thongtin_khachhang">
                    <div id="thongtin_khachhang_min" >
                        ...
                        <p runat="server" id="thongtin_stundentcode">Mã sinh viên: </p>
                        <p runat="server" id="thongtin_username">Username: </p>
                    </div>

                    <div id="thongtin_khachhang_thaydoi" ClientIDMode="Static" runat="server">                      
                        <p>*Vì bảo mật nên bạn không thể thay đổi số điện thoại,mail, mã sinh viên và username</p>
                        <input type="text" placeholder="Fistname" id="namenew" name="Fistname" value=""/>
                        <input type="text" placeholder="Lastname" id="addnew" name="Lastname" value=""/> 
